...
@section('content')
    <section class="row gy-4 pt-120 justify-content-center">
                ...
                <div class="card-body">
                    <form action="{{ route('user.deposit.insert') }}" method="post">
                        ...
                        <div class="form-group">
                            <label for="gateway" class="form--label">@lang('Select Gateway')</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" name="amount" class="form-control form--control"
                                    value="{{ old('amount') }}" id="amount" autocomplete="off" required>
