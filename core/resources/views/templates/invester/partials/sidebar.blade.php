...
<div class="dashboard-sidebar" id="dashboard-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('user.invest.schedule') }}" class="{{ menuActive('user.invest.schedule') }}"><img src="{{ asset($activeTemplateTrue . '/images/icon/schedule.png') }}" alt="icon"> @lang('Schedule Investments')</a></li>
        @endif
